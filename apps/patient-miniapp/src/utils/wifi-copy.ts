...
export const ENTRY = {
  ...
  powerHint: '请确认',
  hint: '提示：本设备仅支持 2.4GHz 家庭 WiFi。如果您家是双频路由器，请连接 2.4G 频段（通常名称带 "2.4G" 字样）。',
  btModal: {
    title: '请打开手机蓝牙',
...
export const SCAN = {
  navTitle: '搜索监测器',
  /** PRD §7A.9 约束：2.4GHz 提示必须前置到扫描页 */
  notice24G: '本设备仅支持 2.4GHz 家庭 WiFi。若您家是双频路由器，请选择名称带 "2.4G" 的网络。',
